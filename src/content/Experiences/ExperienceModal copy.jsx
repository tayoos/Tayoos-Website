        ...
        <div className="ExperienceContainer">
            <div className={`experience-list-modal ${darkMode ? 'dark' : ''}`}>
                {experiences.map((experience) => (
                    <div key={experience.id} className={`experience-item-modal ${selectedExperience.id === experience.id ? 'active' : ''} ${darkMode ? 'dark' : ''}`} onClick={() => handleExperienceClick(experience)}>
                        {experience.title}
                    </div>
                ))}
            </div>
            {selectedExperience && (
                <div className="experience-detail-modal">
                    ...
                    <div className={`skills ${darkMode ? 'dark' : ''}`} dangerouslySetInnerHTML={{ __html: selectedExperience.skills }} />
                    <div className={`ExperienceLongDesc ${darkMode ? 'dark' : ''}`} dangerouslySetInnerHTML={{ __html: selectedExperience.longdesc }} />
                </div>
            )}
        </div>
    );
